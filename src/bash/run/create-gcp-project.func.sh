#!/bin/bash
# ORG_ID=91026469661 GCP_ACCOUNT=ext-yordan.georgiev@futurice.com GCP_BILLING_ACCOUNT_ID=015FE3-BD4862-4B740E ORG=ilm APP=opa ENV=stg ./run -a do_create_gcp_project
